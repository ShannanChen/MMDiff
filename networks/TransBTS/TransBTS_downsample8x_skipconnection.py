...
from BraTS2020.networks.TransBTS.Transformer import TransformerModel
from BraTS2020.networks.TransBTS.PositionalEncoding import FixedPositionalEncoding,LearnedPositionalEncoding
from BraTS2020.networks.TransBTS.Unet_skipconnection import Unet
...
class TransformerBTS(nn.Module):
    def __init__(
        ...
        self.Unet = Unet(in_channels=4, base_channels=16, num_classes=num_classes)
