...
class Trainer:
    ...
    def validation_single_gpu(self, val_dataset,):
        ...
        val_outputs = []
        self.model.eval()
        for idx, batch in tqdm(enumerate(val_dataset), total=len(val_dataset)):
        ...
        for epoch in range(0, self.max_epochs):
            ...
            if (epoch+1) % self.val_every == 0 \
                ...
                if self.ddp:
                    ...
                    val_outputs = distributed_concat(val_outputs, num_total_examples=len(val_dataset.sampler.dataset))
                else :
                    val_outputs = torch.tensor(val_outputs)
